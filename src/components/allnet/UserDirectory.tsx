    ...
    <div className="space-y-5">
      ...
      {users.length === 0 ? (
        ...
        <div className="surface-panel overflow-hidden rounded-2xl">
          <div className="hidden items-center gap-3 border-b border-border/60 bg-muted/40 px-4 py-2 text-[11px] font-medium text-muted-foreground lg:grid lg:grid-cols-[minmax(0,2fr)_8rem_10rem_8rem_9rem_6rem_5rem]">
          ...
          <ul className="divide-y divide-border/50">
            {users.map((u) => {
              ...
              return (
                <li
                  key={u.username}
                  className="group flex flex-wrap items-center gap-x-3 gap-y-1 px-4 py-2 text-sm transition-colors hover:bg-muted/40 lg:grid lg:grid-cols-[minmax(0,2fr)_8rem_10rem_8rem_9rem_6rem_5rem] lg:gap-3"
                >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[11px] leading-4 text-muted-foreground">
              דרישת סיסמה: מינימום 6 תווים, לפחות אות אחת באנגלית, ולפחות אות אחת גדולה.
            </p>
          </div>
        ...
        <DialogFooter className="flex-row-reverse justify-start gap-2">
          <Button
            ...
            onClick={() => {
              ...
              if (pw.length < 6 || !/[A-Za-z]/.test(pw) || !/[A-Z]/.test(pw)) {
                toast.error("הסיסמה חייבת להכיל מינימום 6 תווים, לפחות אות אחת באנגלית, ולפחות אות אחת גדולה.");
                return;
              }
